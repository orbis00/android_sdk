...
public class Device {
    ...
    public static String fetchIpAddress(){
        ...
        try {
            ...
            Log.e(Configuration.MKT_SDK_TAG.value,"No device ipAddress found!");
        }
        return ipAddress;
    }
    ...
    public static String fetchAppVersion() {
        ...
        try {
            ...
            Log.i(Configuration.MKT_SDK_TAG.value, "No app version found");
        }
        Log.i(Configuration.MKT_SDK_TAG.value, "App version :"+appVersion);

        return appVersion;
    }

    public static JSONObject fetchDeviceLocation() {
        String location = Mkt.getSharedStorage().getString(Configuration.DEVICE_LOCATION_KEY.value, null);
        ...
        String orgToken = Mkt.getOrgToken();
        final String url = MktUrlWrapper.addQueryParam(
                MktUrlWrapper.addQueryParam(
